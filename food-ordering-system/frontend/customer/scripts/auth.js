async function login() {
  ...
  let result = await post("../../api/customer/customer-login.php", data);
...
async function register() {
  ...
  let result = await post("../../api/customer/customer-register.php", data);
...
async function loginCheck() {
  ...
  if (login_state === true) goTo("./index.html");
}
